...
<head>
    ...
    <style type="text/css">
        .body{
            background: url(../../uploaddir/7854.jpg);
...
<div>
    <div class="div">
        ...
        <div class="sex"><font style="color:white;font-weight: bolder ">性别：</font>
            <c:if test="${sessionScope.jsp.sex==0}">
                <div style="color:white;font-weight:bolder;width: 140px;height: 20px;background: #e3e4e5;font-size: 14px;color: darkorange;border: 2px solid white">男</div>
            </c:if>
            <c:if test="${sessionScope.jsp.sex==1}">
                <div style="color:white;font-weight:bolder;width: 140px;height: 20px;background: #e3e4e5;font-size: 14px;color: darkorange;border: 2px solid white">女</div>
            </c:if>
